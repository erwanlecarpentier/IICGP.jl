...
do
	...
	echo "#SBATCH -n 7" >> atari_pooling_$GAME.cmd
	echo "#SBATCH --ntasks-per-node=7" >> atari_pooling_$GAME.cmd
	...
	echo "julia --threads 7 --project=/users/p21001/lecarpen/IICGP.jl scripts/atari_monocgp.jl --cfg=cfg/monocgp_atari_pooling.yaml --game=$GAME" >> atari_pooling_$GAME.cmd
