...
for r in rom_names
    ...
    println(string(
        ...
        b, pre, r, suffix, "/maxfit_vs_gen", post, b))
    println(string(
        b, pre, r, suffix, "/validation_vs_gen", post,
        b, pre, r, suffix, "/bound_scale_vs_gen", post, b))
    println(string(
        b, pre, r, suffix, "/neval_vs_gen", post,
        b, pre, r, suffix, "/total_n_eval", post, b))
    println(string(
        b, pre, r, suffix, "/nevalperind_vs_gen", post,
