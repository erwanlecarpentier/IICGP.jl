...
@add_arg_table! s begin
    ...
    default = "cfg/atari_encoder_test.yaml"
    "--controller_cfg"
    help = "configuration script"
    default = "cfg/atari_controller_test.yaml"
    "--game"
    help = "game rom name"
    default = "kung_fu_master"
    "--seed"
...
fit(encoder::CGPInd, controller::CGPInd) = play_atari(encoder, controller, max_frames=18000)
